...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/var/www/html/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_ROOT_PATH', '/var/www/html/formulize' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/var/www/Impress' );
	define( 'XOOPS_TRUST_PATH', '/var/www/Impress' );

	include_once XOOPS_TRUST_PATH . '/878363c13550e1baa20e8180deee0f55.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost/formulize' );
	// ALTERED BY FREEFORM SOLUTIONS...
	// AS DEFINED IN INSTALLER BY USER:
	// define( 'XOOPS_URL', 'http://localhost/formulize' );
	// AS DETERMINED FROM FIRST PRINCIPLES:
	...
	define('XOOPS_DB_DSN', 'host='. SDATA_DB_HOST.';dbname='.SDATA_DB_NAME);
